        ...
        <div class="row row-centered text-center version-info">
            <div class="col-xs-12 col-sm-8 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li><strong>Pi-hole Version</strong> <?php echo $coreVersionStr; ?></li>
                    <li><strong>Web Interface Version</strong> <?php echo $webVersionStr; ?></li>
                    <li><strong>FTL Version</strong> <?php echo $ftlVersionStr; ?></li>
                </ul>
                <?php } else { ?>
                <ul class="list-inline">
                    <li>
                        <strong>Pi-hole Version</strong>
                    ...
                    <li>
                        <strong>Web Interface Version</strong>
