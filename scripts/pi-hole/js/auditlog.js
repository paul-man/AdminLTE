      ...
      if (Object.prototype.hasOwnProperty.call(data.top_queries, domain)) {
        ...
        domaintable.append(
          "<tr><td>" +
            ...
            "</td> <td>" +
            '<button type="button" class="btn btn-default btn-xs text-red"><i class="fas fa-ban"></i> Blacklist</button>' +
            '<button type="button" class="btn btn-default btn-xs text-orange"><i class="fas fa-balance-scale"></i> Audit</button>' +
            "</td> </tr> "
        );
      }
    }
